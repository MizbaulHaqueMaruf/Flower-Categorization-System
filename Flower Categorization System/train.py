...
model = myModel.build_network(network_architecture, hidden_units)
model.class_to_idx = train_data.class_to_idx

model, criterion = myModel.train_network(model, epochs, learning_rate, trainloader, validloader, gpu)
myModel.evaluate_model(model, testloader, criterion, gpu)
myModel.save_model(model, network_architecture, hidden_units, epochs, learning_rate, save_dir)